      ...
      {topics.map((topic, i) => {
        ...
        return (
          <li key={topic.note_id} className="flex items-center gap-2.5">
            <span className="w-5 shrink-0 text-right font-mono text-xs text-[#71717a]">
              {i + 1}
            </span>
            <div className="relative min-w-0 flex-1 overflow-hidden rounded">
              ...
              <div className="relative flex items-center justify-between gap-2 px-2 py-1.5">
                <span className="truncate text-xs text-[#f4f4f5]">
                  {topic.title || "(无标题)"}
                </span>
                <div className="flex shrink-0 items-center gap-2 text-xs text-[#71717a]">
